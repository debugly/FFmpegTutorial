...
@interface MR0x24AudioQueueRenderer ()
{
...
@implementation MR0x24AudioQueueRenderer
...
{
    MR0x24AudioQueueRenderer *am = (__bridge MR0x24AudioQueueRenderer *)inUserData;
