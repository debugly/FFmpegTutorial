...
@implementation MRGLES2NV12View
...
- (BOOL)setupGL
{
    ...
    if (!self.openglCompiler) {
        self.openglCompiler = [[MROpenGLCompiler alloc] initWithvshName:@"common_es2.vsh" fshName:@"2_sampler2D_es2.fsh"];
