...
@implementation MRGLES2YUV420PView
...
- (BOOL)setupGL
{
    ...
    if (!self.openglCompiler) {
        self.openglCompiler = [[MROpenGLCompiler alloc] initWithvshName:@"common_es2.vsh" fshName:@"3_sampler2D_es2.fsh"];
