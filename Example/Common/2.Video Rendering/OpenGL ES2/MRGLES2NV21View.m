...
@implementation MRGLES2NV21View
...
- (BOOL)setupGL
{
    ...
    if (!self.openglCompiler) {
        self.openglCompiler = [[MROpenGLCompiler alloc] initWithvshName:@"common_es2.vsh" fshName:@"2_sampler2D_NV21_es2.fsh"];
