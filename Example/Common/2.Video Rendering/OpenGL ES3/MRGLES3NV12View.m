...
@implementation MRGLES3NV12View
...
- (BOOL)setupGL
{
    ...
    if (!self.openglCompiler) {
        self.openglCompiler = [[MROpenGLCompiler alloc] initWithvshName:@"common_es3.vsh" fshName:@"2_sampler2D_es3.fsh"];
