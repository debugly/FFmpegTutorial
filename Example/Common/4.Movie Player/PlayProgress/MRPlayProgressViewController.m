//
//  MRPlayProgressViewController.m
...
#import "MRPlayProgressViewController.h"
...
@interface MRPlayProgressViewController ()
...
@implementation MRPlayProgressViewController
...
- (void)parseURL:(NSString *)url
{
    ...
    __weakSelf__
    player.onStreamOpened = ^(FFTPlayer0x34 *player,NSDictionary * _Nonnull info) {
        __strongSelf__
...
#warning 这里为了简单就先延迟2s再播放
    ...
    player.onError = ^(FFTPlayer0x34 *player, NSError * _Nonnull e) {
        __strongSelf__
        [self.indicatorView stopAnimation:nil];
