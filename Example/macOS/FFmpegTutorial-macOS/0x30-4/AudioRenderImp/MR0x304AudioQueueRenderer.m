...
@interface MR0x304AudioQueueRenderer ()
{
...
@implementation MR0x304AudioQueueRenderer
...
{
    MR0x304AudioQueueRenderer *am = (__bridge MR0x304AudioQueueRenderer *)inUserData;
