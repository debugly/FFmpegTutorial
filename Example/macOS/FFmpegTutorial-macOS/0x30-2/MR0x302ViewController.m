...
#import "MR0x302ViewController.h"
#import <FFmpegTutorial/FFPlayer0x302.h>
#import "MRRWeakProxy.h"

@interface MR0x302ViewController ()

@property (strong) FFPlayer0x302 *player;
...
@implementation MR0x302ViewController
...
- (void)parseURL:(NSString *)url
{
    ...
    FFPlayer0x302 *player = [[FFPlayer0x302 alloc] init];
