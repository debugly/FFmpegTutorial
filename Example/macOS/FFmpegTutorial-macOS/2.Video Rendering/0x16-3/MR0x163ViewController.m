...
#import "MR0x163ViewController.h"
...
@interface MR0x163ViewController ()

@property (strong) FFTPlayer0x10 *player;
@property (weak) IBOutlet NSTextField *inputField;
@property (weak) IBOutlet NSProgressIndicator *indicatorView;
@property (weak) IBOutlet MR0x163VideoRenderer *videoRenderer;
...
@implementation MR0x163ViewController
