...
#import "MR0x164ViewController.h"
...
@interface MR0x164ViewController ()

@property (strong) FFTPlayer0x10 *player;
@property (weak) IBOutlet NSTextField *inputField;
@property (weak) IBOutlet NSProgressIndicator *indicatorView;
@property (weak) IBOutlet MR0x164VideoRenderer *videoRenderer;
...
@implementation MR0x164ViewController
