...
@implementation MRLegacyNV21View
...
- (void)setupOpenGLProgram
{
    if (!self.openglCompiler) {
        self.openglCompiler = [[MRLegacyOpenGLCompiler alloc] initWithvshName:@"common.vsh" fshName:@"2_sampler2D_NV21.fsh"];
