...
#import "MR0x161ViewController.h"
...
@interface MR0x161ViewController ()

@property (strong) FFTPlayer0x10 *player;
@property (weak) IBOutlet NSTextField *inputField;
@property (weak) IBOutlet NSProgressIndicator *indicatorView;
@property (weak) IBOutlet MR0x161VideoRenderer *videoRenderer;
...
@implementation MR0x161ViewController
