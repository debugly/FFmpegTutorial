...
#import "MR0x166ViewController.h"
...
@interface MR0x166ViewController ()

@property (strong) FFTPlayer0x10 *player;
@property (weak) IBOutlet NSTextField *inputField;
@property (weak) IBOutlet NSProgressIndicator *indicatorView;
@property (weak) IBOutlet MR0x166VideoRenderer *videoRenderer;
...
@implementation MR0x166ViewController
