...
@interface MR0x202AudioUnitRenderer ()
...
@implementation MR0x202AudioUnitRenderer
...
{
    MR0x202AudioUnitRenderer *am = (__bridge MR0x202AudioUnitRenderer *)inRefCon;
