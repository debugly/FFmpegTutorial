...
@interface MR0x202AudioQueueRenderer ()
{
...
@implementation MR0x202AudioQueueRenderer
...
{
    MR0x202AudioQueueRenderer *am = (__bridge MR0x202AudioQueueRenderer *)inUserData;
