...
@interface MR0x31AudioQueueRenderer ()
{
...
@implementation MR0x31AudioQueueRenderer
...
{
    MR0x31AudioQueueRenderer *am = (__bridge MR0x31AudioQueueRenderer *)inUserData;
