...
@interface MR0x142ViewController ()

@property (weak, nonatomic) IBOutlet MR0x142VideoRenderer *videoRenderer;
...
@implementation MR0x142ViewController
...
- (IBAction)onSelectedVideMode:(UISegmentedControl *)sender
{
    ...
    if (idx == 0) {
        [self.videoRenderer setContentMode:MRViewContentModeScaleToFill0x142];
    } else if (idx == 1) {
        [self.videoRenderer setContentMode:MRViewContentModeScaleAspectFill0x142];
    } else if (idx == 2) {
        [self.videoRenderer setContentMode:MRViewContentModeScaleAspectFit0x142];
    }
}
