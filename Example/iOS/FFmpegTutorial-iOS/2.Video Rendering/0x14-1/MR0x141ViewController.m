...
#import "MR0x141ViewController.h"
...
@interface MR0x141ViewController ()

@property (weak, nonatomic) IBOutlet MR0x141VideoRenderer *videoRenderer;
...
@implementation MR0x141ViewController
...
- (IBAction)onSelectedVideMode:(UISegmentedControl *)sender
{
    ...
    if (idx == 0) {
        [self.videoRenderer setContentMode:MRViewContentModeScaleToFill0x141];
    } else if (idx == 1) {
        [self.videoRenderer setContentMode:MRViewContentModeScaleAspectFill0x141];
    } else if (idx == 2) {
        [self.videoRenderer setContentMode:MRViewContentModeScaleAspectFit0x141];
    }
}
