...
@interface MR0x31ViewController ()<UITextViewDelegate,FFPlayer0x31Delegate>
...
//    player.supportedSampleFormats = MR_SAMPLE_FMT_MASK_FLTP;
    ...
    int sampleRate = [MR0x31AudioRenderer setPreferredSampleRate:44100];
...
{
    self.audioRender = [MR0x31AudioRenderer new];
