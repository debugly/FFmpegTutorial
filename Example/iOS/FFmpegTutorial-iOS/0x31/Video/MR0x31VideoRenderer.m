...
@implementation MR0x31VideoRenderer
...
- (BOOL)loadShaders
{
	...
	vertShaderURL = [[NSBundle mainBundle] URLForResource:@"0x31Shader" withExtension:@"vsh"];
	...
	fragShaderURL = [[NSBundle mainBundle] URLForResource:@"0x31Shader" withExtension:@"fsh"];
