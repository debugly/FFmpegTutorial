...
- (BOOL)loadShaders
{
	...
	vertShaderURL = [[NSBundle mainBundle] URLForResource:@"0x0bShader" withExtension:@"vsh"];
	...
	fragShaderURL = [[NSBundle mainBundle] URLForResource:@"0x0bShader" withExtension:@"fsh"];
