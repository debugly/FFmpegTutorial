...
@implementation MR0x22VideoRenderer
...
- (BOOL)loadShaders
{
	...
	vertShaderURL = [[NSBundle mainBundle] URLForResource:@"0x22Shader" withExtension:@"vsh"];
	...
	fragShaderURL = [[NSBundle mainBundle] URLForResource:@"0x22Shader" withExtension:@"fsh"];
