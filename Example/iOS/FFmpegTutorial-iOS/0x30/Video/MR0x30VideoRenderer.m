...
- (BOOL)loadShaders
{
	...
	vertShaderURL = [[NSBundle mainBundle] URLForResource:@"0x30Shader" withExtension:@"vsh"];
	...
	fragShaderURL = [[NSBundle mainBundle] URLForResource:@"0x30Shader" withExtension:@"fsh"];
