...
@interface MR0x30ViewController ()<UITextViewDelegate,FFPlayer0x30Delegate>
...
@property (nonatomic, strong) FFPlayer0x30 *player;
@property (weak, nonatomic) IBOutlet MR0x30VideoRenderer *renderView;
...
//    player.supportedSampleFormats = MR_SAMPLE_FMT_MASK_FLTP;
    ...
    int sampleRate = [MR0x30AudioRenderer setPreferredSampleRate:44100];
...
{
    self.audioRender = [MR0x30AudioRenderer new];
