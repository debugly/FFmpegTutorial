...
//视频宽；单位像素
kFFPlayer0x20InfoKey kFFPlayer0x20Width = @"kFFPlayer0x20Width";
//视频高；单位像素
kFFPlayer0x20InfoKey kFFPlayer0x20Height = @"kFFPlayer0x20Height";

@interface  FFPlayer0x20 ()<FFDecoderDelegate0x20>
{
    //音频流解码器
    FFDecoder0x20 *_audioDecoder;
    //视频流解码器
    FFDecoder0x20 *_videoDecoder;
    ...
    */
    ...
    if (st_index[AVMEDIA_TYPE_VIDEO] >= 0){
        ...
        if (!_videoDecoder) {
            ...
            [dumpDic setObject:@(_videoDecoder.picWidth) forKey:kFFPlayer0x20Width];
            [dumpDic setObject:@(_videoDecoder.picHeight) forKey:kFFPlayer0x20Height];
...
- (void)decoder:(FFDecoder0x20 *)decoder reveivedAFrame:(AVFrame *)aFrame
{
