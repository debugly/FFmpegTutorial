...
{
    MRHudRowView *rowView = [tableView makeViewWithIdentifier:@"Row" owner:self];
    if (rowView == nil) {
        rowView = [[MRHudRowView alloc]init];
         ...
         cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    MRHudViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"hud"];
    if (cell == nil) {
        cell = [[MRHudViewCell alloc] init];
    }
