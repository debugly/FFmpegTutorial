...
//图像格式转换/缩放器
@property (nonatomic, strong) FFVideoScale0x14 *videoScale;
//PixelBuffer池可提升效率
...
- (FFVideoScale0x14 *)createVideoScaleIfNeed {
    //未指定期望像素格式
    ...
    //创建像素格式转换上下文
    FFVideoScale0x14 *scale = [[FFVideoScale0x14 alloc] initWithSrcPixFmt:format dstPixFmt:MRPixelFormat2AV(firstSupportedFmt) picWidth:self.videoDecoder.picWidth picHeight:self.videoDecoder.picHeight];
    return scale;
}
