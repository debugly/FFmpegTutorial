...
#import "FFPlayer0x11.h"
#import "MRThread.h"
#import "FFPlayerInternalHeader.h"
#import "FFPlayerPacketHeader.h"
#import "FFPlayerFrameHeader.h"
#import "FFDecoder0x11.h"
#import "FFVideoScale0x11.h"
#import "MRConvertUtil.h"

@interface FFPlayer0x11 ()<FFDecoderDelegate0x11>
{
    //解码前的音频包缓存队列
    PacketQueue audioq;
    //解码前的视频包缓存队列
...
//音频解码器
@property (nonatomic, strong) FFDecoder0x11 *audioDecoder;
//视频解码器
@property (nonatomic, strong) FFDecoder0x11 *videoDecoder;
//图像格式转换/缩放器
@property (nonatomic, strong) FFVideoScale0x11 *videoScale;
...
@implementation  FFPlayer0x11

static int decode_interrupt_cb(void *ctx)
{
    FFPlayer0x11 *player = (__bridge FFPlayer0x11 *)ctx;
...
- (FFDecoder0x11 *)openStreamComponent:(AVFormatContext *)ic streamIdx:(int)idx
{
    FFDecoder0x11 *decoder = [FFDecoder0x11 new];
    decoder.ic = ic;
...
- (FFVideoScale0x11 *)createVideoScaleIfNeed {
    //未指定期望像素格式
    ...
    ///创建像素格式转换上下文
    FFVideoScale0x11 *scale = [[FFVideoScale0x11 alloc] initWithSrcPixFmt:format dstPixFmt:MRPixelFormat2AV(firstSupportedFmt) picWidth:self.videoDecoder.picWidth picHeight:self.videoDecoder.picHeight];
    return scale;
}
...
#pragma mark - FFDecoderDelegate0x11

- (int)decoder:(FFDecoder0x11 *)decoder wantAPacket:(AVPacket *)pkt
{
...
- (void)decoder:(FFDecoder0x11 *)decoder reveivedAFrame:(AVFrame *)frame
{
    if (decoder == self.audioDecoder) {
        FrameQueue *fq = &sampq;
        Frame *af = NULL;
