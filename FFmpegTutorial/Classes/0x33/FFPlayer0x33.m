...
#import "FFPlayer0x33.h"
#import "MRThread.h"
#include <libavutil/pixdesc.h>
#include <libavformat/avformat.h>
#import "FFDecoder0x33.h"
...
//视频宽；单位像素
kFFPlayer0x33InfoKey kFFPlayer0x33Width = @"kFFPlayer0x33Width";
//视频高；单位像素
kFFPlayer0x33InfoKey kFFPlayer0x33Height = @"kFFPlayer0x33Height";

//将音频裸流PCM写入到文件
#define DEBUG_RECORD_PCM_TO_FILE 0

@interface  FFPlayer0x33 ()<FFDecoderDelegate0x33>
{
    //音频流解码器
    FFDecoder0x33 *_audioDecoder;
    //视频流解码器
    FFDecoder0x33 *_videoDecoder;
...
@implementation  FFPlayer0x33

static int decode_interrupt_cb(void *ctx)
{
    FFPlayer0x33 *player = (__bridge FFPlayer0x33 *)ctx;
    ...
    */
    ...
    if (st_index[AVMEDIA_TYPE_VIDEO] >= 0){
        ...
        if (!_videoDecoder) {
            ...
            [dumpDic setObject:@(_videoDecoder.picWidth) forKey:kFFPlayer0x33Width];
            [dumpDic setObject:@(_videoDecoder.picHeight) forKey:kFFPlayer0x33Height];
...
- (FFDecoder0x33 *)openStreamComponent:(AVFormatContext *)ic streamIdx:(int)idx
{
    FFDecoder0x33 *decoder = [FFDecoder0x33 new];
    decoder.ic = ic;
...
#pragma mark - FFDecoderDelegate0x33

- (void)decoder:(FFDecoder0x33 *)decoder reveivedAFrame:(AVFrame *)aFrame
{
...
- (MR0x33VideoRenderer *)_videoRender
{
    return (MR0x33VideoRenderer *)_videoRender;
}

- (UIView<MR0x33VideoRendererProtocol> *)videoRender
{
    if (!_videoRender) {
        MR0x33VideoRenderer *videoRender = [[MR0x33VideoRenderer alloc] init];
