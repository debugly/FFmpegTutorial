...
//  FFmpegTutorial
//
//  Created by Matt Reach on 2022/7/20.
//
// 自定义解码器类
// 通过代理衔接输入输出
...
@class FFDecoder0x33;
@protocol FFDecoderDelegate0x33 <NSObject>

@required
///将解码后的 AVFrame 给 delegater
- (void)decoder:(FFDecoder0x33 *)decoder reveivedAFrame:(AVFrame *)frame;

@end

@interface FFDecoder0x33 : NSObject

@property (nonatomic, assign) AVFormatContext *ic;
@property (nonatomic, assign) int streamIdx;
@property (nonatomic, copy) NSString * name;
@property (nonatomic, weak) id <FFDecoderDelegate0x33> delegate;
