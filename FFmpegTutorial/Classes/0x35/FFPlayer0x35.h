...
typedef NSString * const kFFPlayer0x35InfoKey;
//视频宽；单位像素
FOUNDATION_EXPORT kFFPlayer0x35InfoKey kFFPlayer0x35Width;
//视频高；单位像素
FOUNDATION_EXPORT kFFPlayer0x35InfoKey kFFPlayer0x35Height;
//视频时长；单位秒
FOUNDATION_EXPORT kFFPlayer0x35InfoKey kFFPlayer0x35Duration;

typedef struct AVFrame AVFrame;

@interface FFPlayer0x35 : NSObject
...
//lazy getter
@property (nonatomic, strong, nullable) NSView<MR0x35VideoRendererProtocol> *videoRender;
///准备
- (void)prepareToPlay;
///读包
- (void)load;
