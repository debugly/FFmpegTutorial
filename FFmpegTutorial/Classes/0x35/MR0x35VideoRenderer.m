...
@implementation MR0x35VideoRenderer
...
- (void)setContentMode:(MR0x35ContentMode)contentMode
{
    ...
    switch (contentMode) {
        case MR0x35ContentModeScaleAspectFill:
        {
            layer.videoGravity = AVLayerVideoGravityResizeAspectFill;
        }
            break;
        case MR0x35ContentModeScaleAspectFit:
        {
...
- (MR0x35ContentMode)contentMode
{
    ...
    if ([AVLayerVideoGravityResizeAspect isEqualToString:layer.videoGravity]) {
        return MR0x35ContentModeScaleAspectFit;
    } else if ([AVLayerVideoGravityResizeAspectFill isEqualToString:layer.videoGravity]){
        return MR0x35ContentModeScaleAspectFill;
    } else {
        return MR0x35ContentModeScaleToFill;
    }
}
