...
typedef NSString * const kFFPlayer0x30InfoKey;

//视频宽；单位像素
FOUNDATION_EXPORT kFFPlayer0x30InfoKey kFFPlayer0x30Width;
//视频高；单位像素
FOUNDATION_EXPORT kFFPlayer0x30InfoKey kFFPlayer0x30Height;
//视频流时基
FOUNDATION_EXPORT kFFPlayer0x30InfoKey kFFPlayer0x30StreamTimeBase;
//视频桢平均时长
FOUNDATION_EXPORT kFFPlayer0x30InfoKey kFFPlayer0x30AverageDuration;
