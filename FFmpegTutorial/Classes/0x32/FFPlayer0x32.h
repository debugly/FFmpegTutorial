...
typedef NSString * const kFFPlayer0x32InfoKey;
//视频宽；单位像素
FOUNDATION_EXPORT kFFPlayer0x32InfoKey kFFPlayer0x32Width;
//视频高；单位像素
...
//lazy getter
@property (nonatomic, strong, nullable) NSView<MR0x32VideoRendererProtocol> *videoRender;
///准备
- (void)prepareToPlay;
///读包
- (void)play;
