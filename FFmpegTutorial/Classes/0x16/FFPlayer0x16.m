...
{
    //音频流解码器
    FFDecoder0x16 *_audioDecoder;
    //视频流解码器
    FFDecoder0x16 *_videoDecoder;
    ...
    */
    ...
    if (st_index[AVMEDIA_TYPE_VIDEO] >= 0){
        ...
        if (!_videoDecoder) {
            ...
            [dumpDic setObject:@(_videoDecoder.picWidth) forKey:kFFPlayer0x16Width];
            [dumpDic setObject:@(_videoDecoder.picHeight) forKey:kFFPlayer0x16Height];
