...
typedef NSString * const kFFPlayer0x34InfoKey;
//视频宽；单位像素
FOUNDATION_EXPORT kFFPlayer0x34InfoKey kFFPlayer0x34Width;
//视频高；单位像素
FOUNDATION_EXPORT kFFPlayer0x34InfoKey kFFPlayer0x34Height;
//视频时长；单位秒
FOUNDATION_EXPORT kFFPlayer0x34InfoKey kFFPlayer0x34Duration;

typedef struct AVFrame AVFrame;

@interface FFPlayer0x34 : NSObject
...
//lazy getter
@property (nonatomic, strong, nullable) UIView<MR0x34VideoRendererProtocol> *videoRender;
///准备
- (void)prepareToPlay;
///读包
- (void)load;
