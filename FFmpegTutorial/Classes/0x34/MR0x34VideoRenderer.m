...
#import "MR0x34VideoRenderer.h"
#import <AVFoundation/AVSampleBufferDisplayLayer.h>

@implementation MR0x34VideoRenderer
...
- (void)setContentMode:(MR0x34ContentMode)contentMode
{
    ...
    switch (contentMode) {
        case MR0x34ContentModeScaleAspectFill:
        {
            layer.videoGravity = AVLayerVideoGravityResizeAspectFill;
        }
            break;
        case MR0x34ContentModeScaleAspectFit:
        {
...
- (MR0x34ContentMode)contentMode
{
    ...
    if ([AVLayerVideoGravityResizeAspect isEqualToString:layer.videoGravity]) {
        return MR0x34ContentModeScaleAspectFit;
    } else if ([AVLayerVideoGravityResizeAspectFill isEqualToString:layer.videoGravity]){
        return MR0x34ContentModeScaleAspectFill;
    } else {
        return MR0x34ContentModeScaleToFill;
    }
}
