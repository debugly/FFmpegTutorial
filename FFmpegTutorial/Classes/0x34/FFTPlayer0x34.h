...
typedef NSString * const kFFTPlayer0x34InfoKey;
//视频宽；单位像素
FOUNDATION_EXPORT kFFTPlayer0x34InfoKey kFFTPlayer0x34Width;
//视频高；单位像素
FOUNDATION_EXPORT kFFTPlayer0x34InfoKey kFFTPlayer0x34Height;
//视频时长；单位秒
FOUNDATION_EXPORT kFFTPlayer0x34InfoKey kFFTPlayer0x34Duration;

typedef struct AVFrame AVFrame;

@interface FFTPlayer0x34 : NSObject
...
@property (nonatomic, copy) void(^onStreamOpened)(FFTPlayer0x34 *player,NSDictionary *info);
@property (nonatomic, copy) void(^onReadPkt)(FFTPlayer0x34 *player,int a,int v);
@property (nonatomic, copy) void(^onError)(FFTPlayer0x34 *player,NSError *);
//lazy getter
