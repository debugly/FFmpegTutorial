...
@interface MR0x34AudioQueueRenderer ()
{
...
@implementation MR0x34AudioQueueRenderer
...
{
    MR0x34AudioQueueRenderer *am = (__bridge MR0x34AudioQueueRenderer *)inUserData;
