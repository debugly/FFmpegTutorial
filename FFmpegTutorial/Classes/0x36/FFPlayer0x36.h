...
typedef NSString * const kFFPlayer0x36InfoKey;
//视频宽；单位像素
FOUNDATION_EXPORT kFFPlayer0x36InfoKey kFFPlayer0x36Width;
//视频高；单位像素
FOUNDATION_EXPORT kFFPlayer0x36InfoKey kFFPlayer0x36Height;
//视频时长；单位秒
FOUNDATION_EXPORT kFFPlayer0x36InfoKey kFFPlayer0x36Duration;

typedef struct AVFrame AVFrame;

@interface FFPlayer0x36 : NSObject
...
//lazy getter
@property (nonatomic, strong, nullable) UIView<MR0x36VideoRendererProtocol> *videoRender;
