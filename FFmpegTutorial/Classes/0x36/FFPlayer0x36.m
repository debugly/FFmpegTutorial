...
//视频宽；单位像素
kFFPlayer0x36InfoKey kFFPlayer0x36Width = @"kFFPlayer0x36Width";
//视频高；单位像素
kFFPlayer0x36InfoKey kFFPlayer0x36Height = @"kFFPlayer0x36Height";
//视频时长；单位秒
kFFPlayer0x36InfoKey kFFPlayer0x36Duration = @"kFFPlayer0x36Duration";

//将音频裸流PCM写入到文件
#define DEBUG_RECORD_PCM_TO_FILE 0

@interface  FFPlayer0x36 ()<FFDecoderDelegate>
{
    //音频流解码器
...
@implementation  FFPlayer0x36

static int decode_interrupt_cb(void *ctx)
{
    FFPlayer0x36 *player = (__bridge FFPlayer0x36 *)ctx;
    ...
    */
    ...
    if (st_index[AVMEDIA_TYPE_VIDEO] >= 0){
        ...
        if (!_videoDecoder) {
            ...
            [dumpDic setObject:@(_videoDecoder.picWidth) forKey:kFFPlayer0x36Width];
            [dumpDic setObject:@(_videoDecoder.picHeight) forKey:kFFPlayer0x36Height];
